...
const COUNTRIES: CountrySection[] = [
  {
    ...
    tools: [
      ...
      { key: 'student', icon: '🎓', color: 'from-emerald-500 to-emerald-700' },
      {
        key: 'hmrc',
        icon: '📊',
        path: '/hmrc',
  ...
  },
  {
    ...
    tools: [
      ...
      { key: 'pnp', icon: '🏔️', color: 'from-orange-500 to-orange-700' },
      { key: 'canadaStudent', icon: '🎓', color: 'from-emerald-500 to-emerald-700' },
    ],
  },
  {
    ...
    tools: [
      ...
      { key: 'employer186', icon: '🏢', color: 'from-green-500 to-green-700' },
      { key: 'auStudent', icon: '🎓', color: 'from-teal-500 to-teal-700' },
    ],
  },
  {
    countryKey: 'ireland',
    flag: '🇮🇪',
    tools: [
      { key: 'criticalSkills', icon: '💼', color: 'from-green-600 to-green-800' },
      { key: 'stamp4', icon: '🗂️', color: 'from-lime-500 to-lime-700' },
    ],
  },
]
